...
<table>
	<form action="edit-form.php" method="POST">
		<tr>
			<td>Firstname:</td>
			<td><input type="text" value="<?php echo $curr_fn ?>" name="upd_firstname" style="font-size: 13px; font-family: Helvetica, arial, sans-serif;"></td>
		</tr>
		<tr>
			<td>Lastname:</td>
			<td><input type="text" value="<?php echo $curr_ln ?>" name="upd_lastname" style="font-size: 13px; font-family: Helvetica, arial, sans-serif;"></td>
		</tr>
		<tr>
			<td>Street:</td>
			<td><input type="text" value="<?php echo $curr_str ?>" name="upd_street" style="font-size: 13px; font-family: Helvetica, arial, sans-serif;"></td>
		</tr>
		<tr>
			<td>City:</td>
			<td><input type="text" value="<?php echo $curr_cty ?>" name="upd_city" style="font-size: 13px; font-family: Helvetica, arial, sans-serif;"></td>
		</tr>
		<tr>
...
<form action="edit-form.php" method="POST">
	<input type="hidden" name="del_id" value="<?php echo $curr_id ?>">
